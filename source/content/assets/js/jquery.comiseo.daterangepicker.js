	...
	$.widget('comiseo.daterangepicker', {
		...
		options: {
			...
			presetRanges: [
				...
				{text: 'Next Month', dateStart: function() { return moment().add('month', 1).startOf('month') }, dateEnd: function() { return moment().add('month', 1).endOf('month') } },
				{text: 'Year to Date', dateStart: function() { return moment().startOf('year') }, dateEnd: function() { return moment() } },
				{text: 'Previous Year', dateStart: function() { return moment().subtract('year', 1).startOf('year') }, dateEnd: function() { return moment().subtract('year', 1).endOf('year') } }
			],
